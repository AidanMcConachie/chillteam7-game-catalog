...
public class CardTest {
    ...
    public void testCardConstructorAndGetters() {
        ...
        assertEquals(genre, card.getGenre(), "getGenre should return the correct genre");
    ...
    public void testCardConstructorWithNullValues() {
        ...
        assertNull(card.getGenre(), "getGenre should return null");
    ...
    public void testCardConstructorWithEmptyStrings() {
        ...
        assertEquals("", card.getGenre(), "getGenre should return empty string");
    ...
    public void testToString() {
        // Arrange
        Card card = new Card("Zelda", "Adventure", "1", "A legend of Zelda game", "zelda.jpg");
        ...
        assertTrue(result.contains("genre='Adventure'"), "toString should contain the genre");
    ...
    public void testToStringWithNullValues() {
        ...
        assertTrue(result.contains("genre='null'"), "toString should handle null genre");
    ...
    public void testToStringWithEmptyStrings() {
        ...
        assertTrue(result.contains("genre=''"), "toString should handle empty genre");
    ...
    public void testToStringWithSpecialCharacters() {
        // Arrange
        Card card = new Card("Name with spaces", "Action & Adventure", "ID-123",
        ...
        assertTrue(result.contains("genre='Action & Adventure'"), "toString should handle special chars in genre");
